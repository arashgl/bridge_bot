...
export declare namespace ProductNFT {
  ...
  export type LazyNFTVoucherStructOutput = [
    BigNumber,
    BigNumber,
    string,
    string,
...
export interface ProductNFTInterface extends utils.Interface {
  functions: {
    ...
    "recover((uint256,uint256,string,address,bytes))": FunctionFragment;
    "renounceOwnership()": FunctionFragment;
    "safeMint((uint256,uint256,string,address,bytes))": FunctionFragment;
  ...
  encodeFunctionData(
    ...
    values: [ProductNFT.LazyNFTVoucherStruct]
  ): string;
  encodeFunctionData(
...
export interface ProductNFT extends BaseContract {
  ...
  functions: {
    ...
    recover(
      voucher: ProductNFT.LazyNFTVoucherStruct,
      overrides?: CallOverrides
    ): Promise<[string]>;
