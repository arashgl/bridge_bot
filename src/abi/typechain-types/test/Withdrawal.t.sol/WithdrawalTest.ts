...
export interface WithdrawalTestInterface extends utils.Interface {
  functions: {
    ...
    "testWithdrawals()": FunctionFragment;
    "testWithdrawalsOutDev()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testWithdrawals",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "testWithdrawalsOutDev",
    values?: undefined
  ): string;
...
export interface WithdrawalTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: WithdrawalTestInterface;
  ...
  callStatic: {
    ...
    testWithdrawals(overrides?: CallOverrides): Promise<void>;

    testWithdrawalsOutDev(overrides?: CallOverrides): Promise<void>;
