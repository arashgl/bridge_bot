...
export interface NFTLandInterface extends utils.Interface {
  functions: {
...
export interface NFTLand extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NFTLandInterface;
  ...
  functions: {
    ...
    TOTAL_MINTED(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  getUserTokens(user: string, overrides?: CallOverrides): Promise<BigNumber[]>;
  ...
  populateTransaction: {
    ...
    TOTAL_MINTED(overrides?: CallOverrides): Promise<PopulatedTransaction>;
